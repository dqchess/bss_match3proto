...
namespace FullSerializer.Tests {
    ...
    public class VersionedTypeTests {
        ...
        public void DuplicateVersionString()
        {
            ...
            Assert.That(() => fsVersionManager.GetVersionedType(typeof(VersionedModelDuplicateVersionString)),
                Throws.TypeOf<fsDuplicateVersionNameException>());
        }
        ...
        public void MissingConstructor()
        {
            ...
            Assert.That(() => fsVersionManager.GetVersionedType(typeof(VersionedModelMissingConstructor)),
                Throws.TypeOf<fsMissingVersionConstructorException>());
        }
